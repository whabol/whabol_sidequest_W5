...
## GenAI
GenAI was used to help code the reactive camera experience and the background getting greener every time the 
player clicks the up arrow. As well as helping to debug.
